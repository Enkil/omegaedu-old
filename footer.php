...
<div id="vk_groups" style="margin-top:30px; margin-bottom:30px;" class="center-block">
    <script type="text/javascript">
        VK.Widgets.Group("vk_groups", {mode: 0, width: "auto", height: "255", color1: 'FFFFFF', color2: '2B587A', color3: '787878'}, 47913943);
    </script>
</div>
...
<div class="row" style="margin-top:20px; margin-bottom:32px;">
    ...
    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-9 text-center">
        <p style="margin-top:16px; margin-bottom:0px; font-size:21px;">+7 (495) 134 45 17</p>
