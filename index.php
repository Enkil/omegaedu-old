    ...
    <div class="row" style="margin-top:25px;">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-center">
            ...
            <a class="image" href="#"><img class="img-responsive" src="img/mipt_statya_main.png" style="border-radius:15px;"></a>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-center">
            ...
            <a class="image" href="#"><img class="img-responsive" src="img/phys1_video_main.png" style="border-radius:15px;"></a>
            <p style="margin-top:7px; margin-bottom:5px; text-align:center;">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 text-center">
            ...
            <a class="image" href="#"><img class="img-responsive" src="img/menzorova_otz_main.png" style="border-radius:15px;"></a>
            <p style="margin-top:7px; margin-bottom:5px; text-align:center;">
